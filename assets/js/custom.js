...
// ============================================================
// Stats Bar Counters + SAE Swiper mobile fix
// ============================================================
...
// main.js handles .security-slider (desktop).
// The mobile section uses .security-slider-mob so it gets its
// own Swiper instance with the correct pagination element.
// ============================================================
$(document).ready(function () {
  if ($(".security-slider-mob").length && typeof Swiper !== "undefined") {
    new Swiper(".security-slider-mob", {
      slidesPerView: 1,
      spaceBetween: 20,
      loop: true,
      autoplay: {
